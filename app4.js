...
const products = [
  ...
  {id:3, name:'Cotton Tote Bag', price:249, img:'https://i.etsystatic.com/18798117/r/il/b686ab/4939909901/il_fullxfull.4939909901_ebcl.jpg', ecoScore:80},
  {id:4, name:'Solar Lantern', price:999, img:'https://image.made-in-china.com/202f0j00rmocNtySSgbe/Eco-Friendly-Solar-Lantern-with-Torch-Light-Solar-System-for-Home-and-Outdoor-Use-with-Verasol-Certificate.jpg', ecoScore:75},
  {id:5, name:'Cotton Pads', price:100, img:'https://evereve.in/cdn/shop/files/1_4440fb70-7331-44b9-bebc-6b8df76d34d2.jpg?v=1758023308', ecoScore:60},
  {id:6, name:'Eco Pen', price:49, img:'https://brownliving.in/cdn/shop/products/eco-friendly-pens-2-refillable-ball-pen-sustainable-wooden-pens-tbb-100-stationery-brown-living-232279.jpg?v=1682962196&width=1105', ecoScore:65},
  {id:7, name:'Solar Light', price:5000, img:'https://static.vecteezy.com/system/resources/previews/059/912/076/large_2x/light-bulb-on-solar-panel-on-green-lawn-green-energy-eco-friendly-technology-and-sustainable-lifestyle-photo.jpg', ecoScore:80}
];
...
// 💚 Buy Now → Save to Orders + Redirect to myorder.html
function buyNow(id) {
  ...
  const newOrder = {
    ...
    category: product.category || "Eco Product",
    origin: product.origin || "India",
    buyerName: localStorage.getItem('ecoUser') || "Guest User",
    buyerAddress: "Will be updated soon",
  ...
  alert(`${product.name} — your order has been placed successfully ✅`);
  window.location.href = "myorder.html";
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 📦 Orders Page logic (myorder.html)
